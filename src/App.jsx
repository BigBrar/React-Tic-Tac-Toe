    ...
    <main>
      <div id="game-container">
        <ol id="players" className='highlight-player'>
          <Player name='Player 1' symbol="X" isActive={activePlayer ==='X'} savePlayerName={handlePlayerNameChange} />
          <Player name='Player 2' symbol="O" isActive={activePlayer ==='O'} savePlayerName={handlePlayerNameChange} />
        </ol>
